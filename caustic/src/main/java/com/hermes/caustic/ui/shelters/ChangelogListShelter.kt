...
class ChangelogListShelter(var manager: HermesManager, var activityChangelogListViewBinding: ChangelogListViewBinding) : Shelter(activityChangelogListViewBinding) {
